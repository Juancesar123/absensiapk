...
export class ForminputsuratketeranganComponent {
  ...
  public uploadImage() {
    // Destination URL
    var url = "http://192.168.43.132:3030/tmpsuratketerangan";
    ...
    var options = {
      ...
      params : {"gambar": "http://192.168.43.132/img/"+filename,'note': this.note,"keterangan":this.keterangan,"nama":this.datauser.nama,"tanggal":this.inputtanggal,status:'pending'}
    };
